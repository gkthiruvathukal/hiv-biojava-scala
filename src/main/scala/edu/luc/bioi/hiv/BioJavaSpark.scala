...
object BioJavaSpark {
  ...
  def sparkMain(args: Array[String]) {
    ...
    // TODO: Bind lambda to parse Genbank (data). Aggregate by gene.
  }
  ...
  // this is just to see how long it takes to read all files into memory (using Java NIO)

  def timeLocalRead(args: Array[String]): Unit = {
